...
describe('AppComponent', () => {
  ...
  it(`should have the 'Gerenciador-Financas-Angular' title`, () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;
    expect(app.title).toEqual('Gerenciador-Financas-Angular');
  });
  ...
  it('should render title', () => {
    ...
    expect(compiled.querySelector('h1')?.textContent).toContain('Hello, Gerenciador-Financas-Angular');
  });
});
